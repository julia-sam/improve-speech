...
function App() {
  // ----------------------------------------------------------------
  // 1) Separate State for TTS audio / User audio / Pitch analyses
  // ----------------------------------------------------------------
  const [ttsAudioURL, setTtsAudioURL] = useState(null);    // AI TTS (MP3) Blob URL
  const [recordingAudioURL, setRecordingAudioURL] = useState(null); // User recording Blob URL

  const [aiPitchAnalysis, setAiPitchAnalysis] = useState([]);   // AI pitch data
  const [userPitchAnalysis, setUserPitchAnalysis] = useState([]); // User pitch data
  ...
  // ----------------------------------------------------------------
  // 2) Generate TTS (MP3) -> Convert to WAV -> Analyze -> aiPitchAnalysis
  // ----------------------------------------------------------------
  ...
  // ----------------------------------------------------------------
  // 4) AI Pitch Endpoint (similar to fetchPitch, but sets AI pitch)
  // ----------------------------------------------------------------
  ...
  // ----------------------------------------------------------------
  // 6) Recording: WebM -> WAV -> userPitchAnalysis
  // ----------------------------------------------------------------
  ...
  // ----------------------------------------------------------------
  // 9) WaveSurfer for User Recording
  // ----------------------------------------------------------------
  useEffect(() => {
